...
int __attribute__((constructor)) SKRXHOOKInit()
{
	...
	cvar->ConsoleColorPrintf(ColorRGBA(150, 255, 150), "SKRXHOOK was successfully injected.\n");
...
void __attribute__((destructor)) SKRXHOOKShutdown()
{
	...
	*(CamThinkSvCheatsCheck + 0x1) = 0x64;
	...
	cvar->ConsoleColorPrintf(ColorRGBA(255, 150, 150), "SKRXHOOK has been unloaded successfully.\n");
}
