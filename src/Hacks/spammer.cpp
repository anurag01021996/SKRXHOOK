...
std::vector<std::string> Settings::Spammer::KillSpammer::messages = {
		"$nick just got owned by SKRXHOOK",
		"$nick watches anime",
};
bool Settings::Spammer::RadioSpammer::enabled = false;
std::vector<std::string> Settings::Spammer::NormalSpammer::messages = {
		"SKRXHOOK owns me and all",
		"Your Windows p2c sucks my SKRXHOOK dry",
		"It's free as in FREEDOM!",
		"SKRXHOOK only let me out so I could play this game, please be nice!",
		"SKRXHOOK nutted but you keep sucken",
		">tfw no vac on Linux"
};
